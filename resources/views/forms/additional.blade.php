                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="street" class="form-control" name="street" placeholder="example@example.com">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group focused">
                                ...
                                <input type="text" id="current_password" class="form-control" name="ward" placeholder="Ward No.">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group focused">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group focused">
                                ...
                                <input type="text" id="zone" class="form-control" name="zone" placeholder="Zone">
                            </div>
                        </div>
                    </div>
                </div>
